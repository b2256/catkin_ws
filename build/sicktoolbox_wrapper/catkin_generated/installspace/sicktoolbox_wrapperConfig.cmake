...
if("FALSE" STREQUAL "TRUE")
  ...
  set(sicktoolbox_wrapper_DEVEL_PREFIX /home/b2256/catkin_ws/build/devel)
  ...
  set(sicktoolbox_wrapper_INSTALL_PREFIX /usr/local)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sicktoolbox_wrapper' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  ${_report}")
    endif()
