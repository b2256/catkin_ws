...
struct NavSTATUS_
{
  ...
  enum {
    ...
    DGPSISTAT_NONE = 0u,
    DGPSISTAT_PR_PRR = 1u,
    MAPMATCHING_MASK = 192u,
    MAPMATCHING_NONE = 0u,
    MAPMATCHING_VALID = 64u,
    MAPMATCHING_USED = 128u,
    MAPMATCHING_DR = 192u,
    PSMSTATE_ACQUISITION = 0u,
    PSMSTATE_TRACKING = 1u,
    PSMSTATE_POWER_OPTIMIZED_TRACKING = 2u,
    PSMSTATE_INACTIVE = 3u,
  };
