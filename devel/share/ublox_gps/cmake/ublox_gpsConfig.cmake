...
if("TRUE" STREQUAL "TRUE")
  set(ublox_gps_SOURCE_PREFIX /home/b2256/catkin_ws/src/ublox_gps)
  set(ublox_gps_DEVEL_PREFIX /home/b2256/catkin_ws/devel)
  ...
  set(ublox_gps_INSTALL_PREFIX /home/b2256/catkin_ws/install)
...
if(NOT "/home/b2256/catkin_ws/src/ublox_gps/include " STREQUAL " ")
  set(ublox_gps_INCLUDE_DIRS "")
  set(_include_dirs "/home/b2256/catkin_ws/src/ublox_gps/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT "http://ros.org/wiki/ublox_gps " STREQUAL " ")
    set(_report "Check the website 'http://ros.org/wiki/ublox_gps' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Johannes Meyer <nothing@nobody.com>, Gareth Cross <gcross.code@icloud.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ublox_gps' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/b2256/catkin_ws/src/ublox_gps/${idir}'.  ${_report}")
    endif()
