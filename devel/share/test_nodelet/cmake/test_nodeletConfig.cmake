...
if("TRUE" STREQUAL "TRUE")
  set(test_nodelet_SOURCE_PREFIX /home/b2256/catkin_ws/src/nodelet_core/test_nodelet)
  set(test_nodelet_DEVEL_PREFIX /home/b2256/catkin_ws/devel)
  ...
  set(test_nodelet_INSTALL_PREFIX /home/b2256/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'test_nodelet' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/b2256/catkin_ws/src/nodelet_core/test_nodelet/${idir}'.  ${_report}")
    endif()
