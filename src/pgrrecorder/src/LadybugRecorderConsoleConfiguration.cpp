...
namespace LRCConfig
{
  ...
  void Camera::
  setDataFormat (::std::auto_ptr< DataFormatType > x)
  {
    this->DataFormat_.set (x);
  }
  ...
  void Camera::
  setJpegQualityPercentage (::std::auto_ptr< JpegQualityPercentageType > x)
  {
    this->JpegQualityPercentage_.set (x);
  }
  ...
  void Stream::
  setDestinationDirectory (::std::auto_ptr< DestinationDirectoryType > x)
  {
    this->DestinationDirectory_.set (x);
  }
  ...
  void Configuration::
  setCamera (::std::auto_ptr< CameraType > x)
  {
    this->Camera_.set (x);
  }
  ...
  void Configuration::
  setStream (::std::auto_ptr< StreamType > x)
  {
    this->Stream_.set (x);
  }
...
namespace LRCConfig
{
  ...
  Configuration::
  Configuration (const GeneralType& General,
                 ::std::auto_ptr< CameraType > Camera,
                 ::std::auto_ptr< GPSType > GPS,
...
namespace LRCConfig
{
  ::std::auto_ptr< ::LRCConfig::Configuration >
                      ...
                      const ::xml_schema::Properties& p)
  {
    ...
    return ::std::auto_ptr< ::LRCConfig::Configuration > (
                      ...
                      const ::xml_schema::Properties& p)
  {
    ...
    {
      ::std::auto_ptr< ::LRCConfig::Configuration > r (
  ...
  ::std::auto_ptr< ::LRCConfig::Configuration >
  parseConfiguration (::xml_schema::dom::auto_ptr< xercesc::DOMDocument > d,
                      ::xml_schema::Flags f,
