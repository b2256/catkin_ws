...
namespace LRCConfig
{
  ...
  class Camera: public ::xml_schema::Type
  {
     ...
     */
    void
    setDataFormat (::std::auto_ptr< DataFormatType > p);
     ...
     */
    void
    setJpegQualityPercentage (::std::auto_ptr< JpegQualityPercentageType > p);
  ...
  class Stream: public ::xml_schema::Type
  {
     ...
     */
    void
    setDestinationDirectory (::std::auto_ptr< DestinationDirectoryType > p);
  ...
  class Configuration: public ::xml_schema::Type
  {
     ...
     */
    void
    setCamera (::std::auto_ptr< CameraType > p);
     ...
     */
    void
    setStream (::std::auto_ptr< StreamType > p);
     ...
     */
    Configuration (const GeneralType&,
                   ::std::auto_ptr< CameraType >,
                   ::std::auto_ptr< GPSType >,
